...
`/tmp` (where the fable fleet wrote them — ephemeral, not a citable substrate).

- **gold** backs `writeups/RESEARCH-GOLDARF.md` (Gold-quadric Tier-2 assault).
- **audit** backs `AUDIT.md` (the correctness sweep; folded from the former AUDIT-FABLE.md).
- **excess** backs `writeups/RESEARCH-EXCESS.md` (transfinite nim excess; see also the
